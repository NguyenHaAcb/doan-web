    ...
    <div class="container lg:grid grid-cols-12 gap-6 items-start pb-16 pt-4">
                ...
                <?php foreach ($cart_list as $order_detail) { ?>
                    ...
                    <div class="flex items-center md:justify-between gap-4 md:gap-6 p-4 border border-gray-200 rounded flex-wrap md:flex-nowrap">
                        ...
                        <div class="w-32 flex-shrink-0">
                            <img src="<?php echo $order_detail['img']?>" class="w-full">
                        </div>
                        <!-- cart image end -->
                        <!-- cart content -->
        ...
        <div class="xl:col-span-3 lg:col-span-4 border border-gray-200 px-4 py-4 rounded mt-6 lg:mt-0">
            ...
            <div class="flex mb-5">
                ...
                <button type="submit" class="bg-primary border border-primary text-white px-5 font-medium rounded-r-md hover:bg-transparent hover:text-primary transition text-sm font-roboto" style="height:34px; margin-top:5px;">
                    Apply
                </button>
            </div>
            <!-- searchbar end -->
            ...
            <a href="checkout.php" class="bg-primary border border-primary text-white px-4 py-3 font-medium rounded-md uppercase hover:bg-transparent
             hover:text-primary transition text-sm w-full block text-center" style="width:260px; ">
                Process to checkout
            </a>
            <!-- checkout end -->
        </div>
